...
//        System.out.println(f.getAbsoluteFile());
    ...
    public void testExport() {
        File f = wordTemplateTools.buildBondFile("汉丽轩·昭通店", 5, 30f, "2017-04-11 20:02:33", "20170412100005");
        System.out.println(f.getAbsoluteFile());
        File f2 = wordTemplateTools.buildTicketFile("汉丽轩·昭通店", "午餐", "2017-04-12 12:30:22", "20170412100006");
