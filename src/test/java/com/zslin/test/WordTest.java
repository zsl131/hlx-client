...
//        System.out.println(f.getAbsoluteFile());
    ...
    public void testExport() {
        File f = wordTemplateTools.buildBondFile("汉丽轩·昭通店", 5, 30f, "2017-04-11 20:02:33", "20170412100005", "0870", "地址");
        System.out.println(f.getAbsoluteFile());
        File f2 = wordTemplateTools.buildTicketFile("汉丽轩·昭通店", "午餐", "2017-04-12 12:30:22", "20170412100006", "0870", "地址");
    ...
    public void testReplaceImage() throws Exception {
        ...
        ImageAdd.replaceImage(wPackage, "${image}", bytes, "test", "haha");
        wPackage.save(new FileOutputStream(targetPath));
    }
    ...
    public void addImage() throws Exception {
        ...
        // Now save it
        wordMLPackage.save(new java.io.File(targetPath) );
    }
}
